...
- Asp. Net - Blazor (utilizar para desenvolver a interface grafica)
- Maui (Mobile) -- Utiliza XAML(GUI)
-----------------
Visual Studio
Vs Code 
framework(dita como você deve programar) ou library  

CRIAR NOVO ARQUIVO MAUI
digita ">" create a new .NET project >> .Net MAUI Blazor Hybrid >> nome 
*/